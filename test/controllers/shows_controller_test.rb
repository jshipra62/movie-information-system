...
class ShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create show" do
    assert_difference('Show.count') do
      post shows_url, params: { show: { movie_id: @show.movie_id, theater_id: @show.theater_id } }
    end
  ...
  test "should update show" do
    patch show_url(@show), params: { show: { movie_id: @show.movie_id, theater_id: @show.theater_id } }
